...
spellbook-repulse-desc = Скажите людям, чтобы они толстые, и оттолкните их от себя.
...
spellbook-hammer-singularity-description = Вы когда-нибудь задумывались, каково это - быть сингулярностью? Размахивайте этим молотком, чтобы рисовать вокруг себя, даже если промахнетесь!
