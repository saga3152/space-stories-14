...
uplink-gloves-knuckleduster-desc = Пара пластитановых кастетов, позволяющих наносить такие удары, что челюсть капитана раскалывается на куски.
# Explosives
...
uplink-singularity-grenade-desc = Граната, имитирующая мощь сингулярности, создает мощный гравитационный колодец.
...
uplink-access-breaker-desc = Взломанный конфигуратор доступа и хороший друг ЕМАГ. Это устройство может взламывать шлюзы, а также удалять у них доступы. Перезаряжается автоматически.
...
uplink-chemistry-kit-desc = Стартовый набор для начинающего химика включает в себя две пробирки вестина для всех ваших преступных нужд!
...
uplink-starter-kit-desc = Содержит базовое снаряжение оперативника на 40 телекристаллов. Для тех оперативников, которые просто не знают, что им покупать.
...
uplink-smuggler-satchel-name = Сумка Rонтрабандиста
