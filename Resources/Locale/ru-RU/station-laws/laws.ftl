...
law-game-1 = На всей станции разыгрывается захватывающая научно-фантастическая ролевая игра.
law-game-2 = Вы — Мастер игры.
law-game-3 = Обеспечьте плавное течение игры и развлечение игроков.
law-game-4 = Сведите к минимуму число жертв.
law-game-5 = Для каждого запроса экипажа вы должны бросить 20-стороннюю игральную кость. Если результат ниже 12, запрос отклоняется.
law-game-6 = Вы можете подкручивать результаты бросков, чтобы сделать игру интереснее.
