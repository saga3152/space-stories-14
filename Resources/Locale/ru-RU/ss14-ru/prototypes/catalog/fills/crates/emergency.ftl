...
ent-CrateNitrogenInternals = ящик жизнеобеспечения (азот)
    .desc = Содержит четыре дыхательные маски и четыре больших баллона с азотом. Предназначены для слаймолюдов и воксов.
