...
ent-CrateNitrogenInternals = ящик с внутренностями (азот)
    .desc = Содержит четыре дыхательные маски и четыре больших баллона с азотом. Предназначены для Slimepeople и Vox.
