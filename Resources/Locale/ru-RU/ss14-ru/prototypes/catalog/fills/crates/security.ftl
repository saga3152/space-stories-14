...
ent-CrateSecNonlethalThrowables = ящик с нелетальными предметами для метания
    .desc = Содержит коробку светошумовых, травматических и слезоточивых гранат, и четыре болы. Для открытия требуется доступ Службы Безопасности.
