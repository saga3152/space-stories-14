...
ent-CrateFunInstrumentsWoodwind = набор деревянных духовых инструментов
    .desc = Если атмосферные техники хорошо справляется со своей работой, воспользуйтесь воздухом, чтобы сыграть на этих деревянных духовых инструментах музыку! Наличие настоящего дерева в каждом экземпляре не гарантируется.
