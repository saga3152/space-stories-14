...
ent-CrateFunFoamGuns = защищённый пенопластовый ящик
    .desc = Содержит четыре пенопластовых ружья, несколько гранат и дополнительные боеприпасы. Либо [УДАЛЕНО], либо ничего!
