...
ent-CrateSecurityRiot = ящик для шпаг
    .desc = Содержит два комплекта брони для бунтарей, шлемы, щиты, а также фортификаторы, заряженные мешками с бобами. Дополнительные патроны прилагаются. Для открытия требуется доступ в оружейную комнату.
