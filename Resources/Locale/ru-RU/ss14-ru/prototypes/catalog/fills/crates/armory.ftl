...
ent-CrateTrackingImplants = ящик с имплантами Трекер
    .desc = Содержит несколько имплантов Трекер. Подходит для заключённых, которых вы хотите освободить, но за которыми продолжается наблюдение.
...
ent-CrateSecurityRiot = ящик снаряжения для подавления беспорядков
    .desc = Содержит два комплекта противоударной брони, шлемы, щиты, а также силовики, заряженные травматическими патронами. Дополнительные патроны прилагаются. Для открытия требуется доступ уровня Оружейной.
