...
ent-PaperSalvageJobLabel = транспортная этикетка утилизационного задания
    .desc = Бумажная этикетка, обозначающая, что ящик содержит груз для выполнения утилизационного задания. Продажа ящика с этой этикеткой завершит задание.
...
ent-PaperNanoTaskItem = элемент НаноТаска
    .desc = Распечатанный элемент НаноТаска. Его можно вставить в ваш КПК, чтобы добавить к своим задачам.