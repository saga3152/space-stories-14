...
ent-CargoRequestSecurityComputerCircuitboard = консоль запросов безопасности (консольная плата)
    .desc = Консольная плата для консоли запросов безопасности.
...
ent-FundingAllocationComputerCircuitboard = консоль распределения финансирования (консольная плата)
    .desc = Консольная плата для консоли распределения финансовых средств.
...
ent-SalvageJobBoardComputerCircuitboard = доска утилизаторских заданий (консольная плата)
    .desc = Консольная плата для доски утилизаторских заданий.
...
ent-RadarConsoleCircuitboard = консоль сканера массы (консольная плата)
    .desc = Консольная плата для консоли сканера массы.
...
ent-ComputerIFFCircuitboard = консоль системы опознавания (консольная плата)
    .desc = Консольная плата для консоли системы опознавания.
ent-ComputerIFFSyndicateCircuitboard = консоль системы опознавания синдиката (консольная плата)
    .desc = Консольная плата для консоли системы опознавания синдиката.
ent-ComputerMassMediaCircuitboard = консоль управления новостями (консольная плата)
    .desc = Консольная плата для консоли управления новостями.
