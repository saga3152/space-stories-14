...
ent-WeaponTemperatureGun = температурная пушка
    .desc = Усовершенствованное оружие, стреляющее лучами изменяющими температуру тела. Вероятно, это является своего рода военным преступлением.
ent-XenoborgLaserGun = лазерный пистолет ксеноборга
    .desc = Экспериментальный пистолет с высокой энергоемкостью лазера и самозаряжающейся ядерной батареей.
ent-XenoborgHeavyLaserGun = тяжелый лазерный пистолет ксеноборга
    .desc = Экспериментальный пистолет с высокой энергоемкостью лазера и самозаряжающейся ядерной батареей.
