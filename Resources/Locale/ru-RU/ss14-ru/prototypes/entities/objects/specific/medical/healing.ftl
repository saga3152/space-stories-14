...
ent-OintmentAdvanced1 = { ent-RegenerativeMesh }
    ...
    .suffix = Один
ent-RegenerativeMeshLingering0 = регенеративная сеть
    .desc = Используется для лечения даже самых серьезных ожогов. Также эффективна против едких ожогов.
...
ent-BrutepackAdvanced1 = { ent-MedicatedSuture }
    ...
    .suffix = Один
ent-MedicatedSutureLingering0 = медицинская нить
    .desc = Нить пропитанная лекарством, эффективно лечит травмы от ударов и закрывает раны.
    .suffix = Не исчезают закончившись, 0
