...
ent-FoodDonkpocketDink = донк-покет
...
ent-FoodDonkpocketMoth = моль-покет
    .desc = Популярная версия донк-покет, которая была создана во время массовых протестов в Сша... На самом деле, кого это волнует? В течение нескольких месяцев только донк-покет.
