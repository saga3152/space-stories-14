...
ent-DrinkLemonLimeCranberryCan = банка «Смити Крэнбери»
    .desc = Хотите банку «Смити Крэнбери»? Любимый напиток администраторов. Употреблять в меру. Ограниченная серия к праздникам!
