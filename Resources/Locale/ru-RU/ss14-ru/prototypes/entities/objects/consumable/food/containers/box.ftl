...
ent-FoodBoxDonkpocketMoth = коробка моль-покет
    .desc = Способ приготовления: Разогрейте в микроволновке. Если продукт не употреблять в течение семи минут, он остынет.
ent-FoodMealHappyHonkBigBite = Happy Honk Большая Порция
    .desc = Кто-то заплатил хорошие деньги за доставку этого блюда из фаст-фуда таким способом. Оно почему-то пахнет свежестью.
