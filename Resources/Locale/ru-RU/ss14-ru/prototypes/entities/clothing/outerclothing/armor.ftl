...
ent-ClothingOuterArmorCentcommCarapace = панцирь ЦентКом
    .desc = Бронированный нагрудник, обеспечивающий защиту при сохранении максимальной подвижности и гибкости. Выдается только официальным лицам и представителям ЦентКом.
