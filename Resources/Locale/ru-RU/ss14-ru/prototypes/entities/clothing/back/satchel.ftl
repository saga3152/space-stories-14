...
ent-ClothingBackpackSatchelSmuggler = сумка контрабандиста
    .desc = Грязная, подозрительного вида сумка.
    .suffix = Пустая
ent-ClothingBackpackSatchelSmugglerUnanchored = сумка контрабандиста
    .desc = Грязная, подозрительного вида сумка.
    .suffix = Пустая, Незакреплённая
ent-BriefcaseSmugglerCash = коричневый чемодан контрабандиста
...
ent-ClothingBackpackDuffelClownSmuggler = вещмешок контрабандиста-клоуна
    .desc = Большая спортивная сумка для хранения дополнительных принадлежностей honk.
    .suffix = Контрабанда, НЕ МАППИТЬ
ent-ClothingBackpackSatchelSmugglerFilled = сумка контрабандиста
    .desc = Грязная, подозрительного вида сумка.
    .suffix = Контрабанда, НЕ МАППИТЬ
ent-RandomSatchelSpawner = рандомная сумка контрабандиста
    .desc = Сумка, открывающаяся в локальный карман блюспейса.
    .suffix = Контрабанда, НЕ МАППИТЬ
