...
ent-ClothingHandsKnuckleDustersStun = парализующие кастеты
    .desc = Пара кастетов, совмещенных с технологией электро-дубинки. Делает избиение грейтайдеров намного проще.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты квартирмейстера
    .desc = 24-каратное золото, усиленное пласталью и украшенное логотипом Nanotrasen. Истинный символ могущества квартирмейстера.
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Латунные кастеты, сделанные так же, как раньше, и бьющие с той же силой.
ent-ClothingHandsKnuckleBoneCrushers = дробитель костей
    .desc = Благословленные богами, чтобы сломить всех кто не подчиняется.
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Кастеты из пластититана с кроваво-красной буквой "S". Настоящий мужчина забьет кого-нибудь до смерти этими штуками.
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные пластальные кастеты, которые делают ваши удары намного сильнее.
