...
ent-InvisibleCrate = { ent-CrateBaseWeldable }
    .suffix = Стелс
    .desc = { ent-CrateBaseWeldable.desc }
ent-CrateBaseLockBox = заблокированный ящик
    .desc = Заблокированный ящик с надежным замком. Средства, вырученные от его продажи, будут возвращены в отдел. Просто помните: стоимость доставки постоянно снижается.
ent-CrateLockBoxEngineering = инженерный заблокированный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = медицинский заблокированный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = охранный заблокированный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = научный заблокированный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = сервисный заблокированный ящик
    .desc = { ent-CrateBaseLockBox.desc }
