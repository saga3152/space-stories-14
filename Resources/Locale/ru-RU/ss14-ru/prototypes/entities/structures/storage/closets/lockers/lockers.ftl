...
ent-LockerPrisoner = шкаф заключённых
    .desc = Это надежный шкафчик для хранения личных вещей заключённого во время его пребывания в тюрьме.
    .suffix = 1
ent-LockerPrisoner1 = { ent-LockerPrisoner }
