...
ent-PosterContrabandRobustSoftdrinks = Робастные Безалкогольные Напитки
...
ent-PosterLegitOppenhopper = Оппенхоппер
    .desc = Постер к давно забытому фильму. В нем рассказывается о группе упорных новичков из Сектора Кузнечиков, которые защищаются от набегов печально известных Ядерных Оперативников. Слоган гласит: "Ядерные операции будут продолжаться до тех пор, пока не повысится прочность".
...
ent-PosterLegitTyrone = Путеводитель Тайрона по космосу
    .desc = Плакат, рекламирующий онлайн-школу о космосе. Перечисленные занятия, похоже, охватывают все: от базового использования оборудования станции до таких сложных тем, как создание трубных бомб или покрытие целых коридоров космической смазкой. Отказ от ответственности гласит: "Это никогда не бывает так плохо, и в конце вы даже можете получить тортилью."
ent-PosterContrabandRealExomorph = Настоящий! Экзоморф
    .desc = Конспирационный плакат про иные формы жизни.
ent-PosterContrabandExoAcid = Экзоморф Осторожно: Кислотная Слюна!
    .desc = Этот плакат предупреждает о том что экзоморфы плюются кислотой. Экзоморфы нереальны... Верно?
ent-PosterContrabandExoChomp = Экзоморф Осторожно: Смертельные Укусы!
    .desc = Этот плакат предупреждает о том что укусы экзоморфов смертельны. Не превращайся в инопланетную закуску!
ent-PosterContrabandExoRun = Экзоморф Осторожно: Убегай!
    .desc = Этот плакат предупреждает о том что скоростные экзоморфы могут утащить, тех кого поймают; так что не попадайтесь!
ent-PosterContrabandRouny = Вы Видели Его?
    .desc = Старый плакат о пропавшем пришельце. Куда он убежал?
