...
ent-BarSignMaltroach = Мольтаракан.
    .desc = Пищит!
ent-BarSignMaltroach = Мольтаракан.
    .desc = Пищит!
ent-BarSignWhiskeyEchoes = Вискей Эхо.
    .desc = Элитный бар для элитных сотрудников... подождите, это же станция Нанотрейзен. Почему этот знак есть в базе данных?
