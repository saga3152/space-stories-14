...
ent-ComputerIFFSyndicate = консоль системы опознавания
    .suffix = Синдикат
    .desc = Позволяет контролировать параметры системы опознавания и характеристики скрытности этого судна.
...
ent-CentcommComputerComms = консоль связи Центрального Командования
    .desc = Компьютер, используемый для подачи всемирных объявлений с помощью клавиатуры. Улучшенный вариант обычной консоли связи.
...
ent-ComputerSalvageJobBoard = доска утилизаторских заданий
    .desc = Консоль для доступа к утилизаторским заданиям, если вы достаточно сильны.
...
ent-ComputerCargoOrdersEngineering = консоль инженерных запросов
    .desc = Используется инженерным отделом для покупки ресурсов.
ent-ComputerFundingAllocation = консоль распределения финансирования
    .desc = Терминал для контроля распределения денежных средств и перевода денежных средств по отделам.
ent-ComputerCargoOrdersMedical = консоль медицинских запросов
    .desc = Используется медицинским отделом для покупки ресурсов.
ent-ComputerCargoOrdersScience = консоль научных запросов
    .desc = Используется научным отделом для покупки ресурсов.
ent-ComputerCargoOrdersSecurity = консоль запросов безопасности
    .desc = Используется отделом службы безопасности для покупки ресурсов.
ent-ComputerCargoOrdersService = консоль сервисных запросов
    .desc = Используется сервисным отделом для покупки ресурсов.