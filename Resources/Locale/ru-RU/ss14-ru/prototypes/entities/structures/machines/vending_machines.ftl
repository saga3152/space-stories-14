...
ent-VendingMachineDiscount = Скидка Дэн
    .desc = Торговый автомат с закусками из печально известной франшизы "Скидка Дэн".
...
ent-VendingMachineDonut = Монкин Пончики
