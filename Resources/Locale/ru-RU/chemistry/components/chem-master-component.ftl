...
chem-master-window-buffer-text = Буфер хранения
chem-master-window-output-buffer-text = Буфер вывода
...
chem-master-window-storage-button = Хранение
chem-master-window-output-button = Вывод
