...
cuffable-component-start-uncuffing-self-observer = {$user} начинает безудержно {REFLEXIVE($target)}!
...
cuffable-component-remove-cuffs-push-success-message = Вы успешно снимаете наручники и толкаете {$otherName} вниз.
