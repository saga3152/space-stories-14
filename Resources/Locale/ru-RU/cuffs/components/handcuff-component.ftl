...
handcuff-component-cuff-self-observer-success-message = {$user} ограничивает {REFLEXIVE($target)}.
...
handcuff-component-cuff-interrupt-other-message = Вы помешали {$otherName} пока { SUBJECT($otherEnt) } { CONJUGATE-BE($otherEnt) } заковывают вас!
