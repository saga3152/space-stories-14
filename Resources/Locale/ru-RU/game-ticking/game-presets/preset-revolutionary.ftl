...
head-rev-role-greeting =
    Вы - глава революции.
    Вам поручено устранить весь командный состав станции путём конвертации, убийства, изгнания за борт, или ареста.
    ...
    Осторожно, она не сработает на тех, у кого есть Щит разума или защитные очки.
    Viva la revolución!
head-rev-briefing =
    Используйте вспышки, чтобы конвертировать членов экипажа на свою сторону.
    Избавьтесь от всех глав или конвертируйте их, чтобы захватить станцию.
