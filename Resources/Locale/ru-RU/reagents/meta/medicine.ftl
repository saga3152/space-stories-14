...
reagent-desc-diphenhydramine = Он же димедрол. Быстро очищает организм от гистамина, снижает возбудимость, вызывает сонливость, лечит поражение ядом. Часто входит в состав препаратов для сна.
...
reagent-desc-doxarubixadone = Криогенный химикат. Лечит клеточные повреждения, вызванные опасными газами и химикатами.
...
reagent-desc-phalanximine = Современный препарат, используемый при лечении рака. Вызывает умеренное лучевое поражение организма, кислотные ожоги и тошноту. Потенциально может удалить ген смерти у растений.
...
reagent-desc-aloxadone = Криогенное химическое вещество. Используется для лечения тяжелых ожогов и обморожения путем регенерации пораженной ткани. Работает независимо от того, жив пациент или мертв.
