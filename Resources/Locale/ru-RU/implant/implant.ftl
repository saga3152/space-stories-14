...
implanter-draw-failed-catastrophically = Имплантер ничего не находит и выходит из строя, нанося генетический урон рукам {$user}!
...
implanter-set-draw-info = Выберите тип имплантата, который должен быть удален имплантером:
