...
guide-entry-bread-recipes = Хлебные Изделия
guide-entry-breakfast-recipes = Еда для Завтрака
guide-entry-moth-recipes = Пища для Моли
...
guide-entry-barsandcookies-recipes = Батончики и Печенья
...
guide-entry-rules-space-law = Космические законы
