...
chat-telephone-message-wrap = [color={ $color }][bold]{ $name }[/bold] говорит, [font={ $fontType } size={ $fontSize }]"{ $message }"[/font][/color]
chat-telephone-message-wrap-bold = [color={ $color }][bold]{ $name }[/bold] говорит, [font={ $fontType } size={ $fontSize }][bold]"{ $message }"[/bold][/font][/color]
# Caller ID
