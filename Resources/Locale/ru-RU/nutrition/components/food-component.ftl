...
food-system-you-cannot-eat-any-more-other = {CAPITALIZE(SUBJECT($target))} больше не лезет!
...
food-system-cant-digest-other = {CAPITALIZE(SUBJECT($target))} не могут переварить { $entity }!
