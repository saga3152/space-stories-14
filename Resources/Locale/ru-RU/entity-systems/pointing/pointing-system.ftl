...
pointing-system-point-in-own-inventory-self = Вы указываете на ваш {$item}.
pointing-system-point-in-own-inventory-others = {CAPITALIZE($pointer)} указывает на {THE($pointer)} {$item}.
