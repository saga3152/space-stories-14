...
id-card-access-level-emergency-shuttle-repeal = Отмена Аварийного Шаттла
...
id-card-access-level-genpop-enter = Вход Общей Зоны
id-card-access-level-genpop-leave = Выход Общей Зоны
