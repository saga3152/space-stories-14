...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> MovementPushingVelocityProduct =
        CVarDef.Create("movement.pushing_velocity_product", -9999f, CVar.SERVER | CVar.REPLICATED); // Stories
    ...
    public static readonly CVarDef<float> MovementPushingCap =
        CVarDef.Create("movement.pushing_cap", 25f, CVar.SERVER | CVar.REPLICATED); // Stories
    ...
    public static readonly CVarDef<float> MovementMinimumPush =
        CVarDef.Create("movement.minimum_push", 0f, CVar.SERVER | CVar.REPLICATED); // Stories
    ...
    public static readonly CVarDef<float> MovementPenetrationCap =
        CVarDef.Create("movement.penetration_cap", 0.5f, CVar.SERVER | CVar.REPLICATED); // Stories
